...
class LittleEndianInputStream(i:InputStream) extends FilterInputStream(i) with DataInput {
  ...
  @throws(classOf[IOException])
  override def readByte():Byte = readUnsignedByte().asInstanceOf[Byte]
  ...
  @throws(classOf[IOException])
  override def readShort():Short = readUnsignedShort().asInstanceOf[Short]
  ...
  @throws(classOf[IOException])
  override def readChar():Char = readUnsignedShort().asInstanceOf[Char]
